from bltGui.Color import Color
from bltGui.Frame import *
from bearlibterminal import terminal

from bltGui.Button import CheckBoxButton, CloseFrameButton, \
    ResizeFrameButton
from bltGui.Frame import Frame, ShowListFrame, ModalFrame
from bltGui.ListBox import ListBox
from bltGui.Radio import Radio
from bltGui.Slider import Slider
from bltGui.TextBox import TextBox
...
terminal.open()
terminal.set(("window: size={0}x{1}, cellsize=auto, title='bltGui Demo'; "
              "font: .\cp437_16x16_alpha_plus.png, size=16x16, "
              "codepage=437".format(80, 50)))
